<template>
  <div class="border-4 border-blue-400 w-[100%] h-[100%] flex flex-col justify-between px-1 md:flex-row flex-wrap">
    ...
    <div v-for="p in profileStore.profiles" :key="p.id" class="border-4 border-red-300 w-[100%] h-[auto] pb-4 p-1 my-4 overflow-hidden text-wrap md:w-[300px] md:h-[410px]">
        <router-link :to="/profile/ + `${p.id}`">
            <div class="border-2 border-blue-300 w-[100%] h-[190px] overflow-hidden">
            ...
            <p class="text-green-700">{{ p.posted }}</p>
